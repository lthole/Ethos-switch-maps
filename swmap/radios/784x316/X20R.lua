-- swmap X20R/X20RS definition for 784x316
-- T5/T6 horizontal
-- no SK/SL
...
return {
        ...
        ["T1"] = {
        ["lines"]={{780, 245, 576, 245}, {576, 245, 564, 257}},
        ["draw"]=function() lcd.drawRectangle(524, 257, 40, 16) lcd.drawLine(544, 257, 544, 272) end
    },
        ["T2"] = {
        ...
        ["T4"] = {
        ["lines"]={{5, 245, 210, 245}, {210, 245, 222, 257}},
        ["draw"]=function() lcd.drawRectangle(222, 257, 40, 16) lcd.drawLine(242, 257, 242, 272) end
    },
        ["T5"] = {
